...
class DataContract:
    ...
    def models(self) -> dict:
        ...
        """
        return self.contract["models"]

    def fields(self, model_name: str) -> dict:
        """
        Returns:
            The fields that make up the schema.
        """
        return self.contract["models"][model_name]["fields"]

    def bigquery_schema(self, model_name: str) -> str:
        """
        ...
        """
        bq_schema = []
        for name, metadata in self.fields(model_name).items():
            schema = {
                "name": name,
    ...
    def json_schema(self, model_name: str) -> dict:
        """
